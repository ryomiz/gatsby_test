  ...
  return (
    <div>
      ...
      <section className="hero">
        <figure>
          <Img
            fluid={data.hero.childrenImageSharp[0].fluid}
            alt=""
            style={{ height: "100%" }}
          />
        </figure>
        ...
        <div className="container">
          ...
          <div className="details">
            <div className="detail">
              <figure>
                <Img fluid={data.fruit.childrenImageSharp[0].fluid} alt="" />
              </figure>
              <h3>フルーツ</h3>
              <p>FRUIT</p>
              <p>
            ...
            <div className="detail">
              <figure>
                <Img fluid={data.grain.childrenImageSharp[0].fluid} alt="" />
              </figure>
              <h3>穀物</h3>
              <p>GRAIN</p>
              <p>
            ...
            <div className="detail">
              <figure>
                <Img fluid={data.beverage.childrenImageSharp[0].fluid} alt="" />
              </figure>
              <h3>飲み物</h3>
              <p>BEVERAGE</p>
              <p>
      ...
      <section className="photo">
        ...
        <figure>
          <Img
            fluid={data.berry.childrenImageSharp[0].fluid}
            alt=""
            style={{ height: "100%" }}
          />
        </figure>
